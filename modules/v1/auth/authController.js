...
import createSesionLogin, {
  ...
  getGoogleOauthToken,
  getGoogleUser,
} from "../../../helpers/helperAuth.js";
import { generatePublicId } from "#root/utils/utilCreateNanoId.js";
import { createAccessJwt, createRefreshJwt } from "../../../utils/utilJwt.js";
import { redisDel, redisGet, redisSet } from "#root/utils/utilRedis.js";
import auth from "./authModel.js";
import { sendEmail } from "../../../service/serviceEmail.js";
...
export const oauthGoogle = async (req, res) => {
  ...
  return res.redirect(process.env.WEB_ENDPOINT);
};
...
export const oauthGithub = async (req, res) => {
  ...
  try {
    ...
    return res.redirect(`${process.env.WEB_ENDPOINT}/oauth/error`);
  }
};
...
<p>Click <a href="${env.clientPort}/verify-otp?${searchParams}">here</a> to verify your email</p>
</div>`,
    };
